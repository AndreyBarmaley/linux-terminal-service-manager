...
* Implemented audio redirect via pulseaudio (both ways)
...
Work is underway to add a folder redirection (from FUSE), video recording of all sessions, and pkcs11 integration.  
