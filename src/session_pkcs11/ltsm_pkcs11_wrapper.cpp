...
namespace LTSM
{
        ...
        dll{ nullptr, dlclose }
    {
        ...
        if(ret != CKR_OK)
        {
            Application::error("%s: %s failed, code: 0x%" PRIx64 ", rv: `%s'", __FUNCTION__, "C_GetFunctionList", ret, rvString(ret));
            throw pkcs11_error(NS_FuncName);
        }
    ...
    CK_SESSION_HANDLE PKCS11::Library::sessionOpen(const SlotId & id, bool rwmode)
    {
        ...
        if(rwmode) flags |= CKF_RW_SESSION;
    ...
    PKCS11::ObjectInfo PKCS11::Session::getObjectInfo(const ObjectHandle & handle, std::initializer_list<CK_ATTRIBUTE_TYPE> types) const
    {
        ...
        size_t buflen = std::accumulate(info.attrs.begin(), info.attrs.end(), 0, [](size_t sum, auto & attr){ return sum += attr.ulValueLen; });
    ...
    {
        auto it = std::find_if(attrs.begin(), attrs.end(), [&](auto & attr){ return attr.type == type; });
    ...
    const char* PKCS11::mechString(const CK_MECHANISM_TYPE & type)
    {
        switch(type)
        {
            ...
            case CKM_DSA_SHA224: return "DSA_SHA224";
            case CKM_DSA_SHA256: return "DSA_SHA256";
            case CKM_DSA_SHA384: return "DSA_SHA384";
            case CKM_DSA_SHA512: return "DSA_SHA512";
            ...
            case CKM_SHA512_224: return "SHA512_224";
            case CKM_SHA512_224_HMAC: return "SHA512_224_HMAC";
            case CKM_SHA512_224_HMAC_GENERAL: return "SHA512_224_HMAC_GENERAL";
            case CKM_SHA512_224_KEY_DERIVATION: return "SHA512_224_KEY_DERIVATION";
            case CKM_SHA512_256: return "SHA512_256";
            case CKM_SHA512_256_HMAC: return "SHA512_256_HMAC";
            case CKM_SHA512_256_HMAC_GENERAL: return "SHA512_256_HMAC_GENERAL";
            case CKM_SHA512_256_KEY_DERIVATION: return "SHA512_256_KEY_DERIVATION";
            case CKM_SHA512_T: return "SHA512_T";
            case CKM_SHA512_T_HMAC: return "SHA512_T_HMAC";
            case CKM_SHA512_T_HMAC_GENERAL: return "SHA512_T_HMAC_GENERAL";
            case CKM_SHA512_T_KEY_DERIVATION: return "SHA512_T_KEY_DERIVATION";
            ...
            case CKM_DES3_CMAC_GENERAL: return "DES3_CMAC_GENERAL";
            case CKM_DES3_CMAC: return "DES3_CMAC";
            ...
            case CKM_DES_OFB64: return "DES_OFB64";
            case CKM_DES_OFB8: return "DES_OFB8";
            case CKM_DES_CFB64: return "DES_CFB64";
            case CKM_DES_CFB8: return "DES_CFB8";
            ...
            case CKM_SECURID_KEY_GEN: return "SECURID_KEY_GEN";
            case CKM_SECURID: return "SECURID";
            case CKM_HOTP_KEY_GEN: return "HOTP_KEY_GEN";
            case CKM_HOTP: return "HOTP";
            case CKM_ACTI: return "ACTI";
            case CKM_ACTI_KEY_GEN: return "ACTI_KEY_GEN";
            ...
            case CKM_CAST128_KEY_GEN: return "CAST128_KEY_GEN";
            //case CKM_CAST5_ECB: return "CAST5_ECB";
            case CKM_CAST128_ECB: return "CAST128_ECB";
            //case CKM_CAST5_CBC: return "CAST5_CBC";
            case CKM_CAST128_CBC: return "CAST128_CBC";
            //case CKM_CAST5_MAC: return "CAST5_MAC";
            case CKM_CAST128_MAC: return "CAST128_MAC";
            //case CKM_CAST5_MAC_GENERAL: return "CAST5_MAC_GENERAL";
            case CKM_CAST128_MAC_GENERAL: return "CAST128_MAC_GENERAL";
            //case CKM_CAST5_CBC_PAD: return "CAST5_CBC_PAD";
            case CKM_CAST128_CBC_PAD: return "CAST128_CBC_PAD";
            ...
            case CKM_TLS_PRF: return "TLS_PRF";
            ...
            case CKM_SHA256_KEY_DERIVATION: return "SHA256_KEY_DERIVATION";
            case CKM_SHA384_KEY_DERIVATION: return "SHA384_KEY_DERIVATION";
            case CKM_SHA512_KEY_DERIVATION: return "SHA512_KEY_DERIVATION";
            ...
            case CKM_PBE_MD5_CAST128_CBC: return "PBE_MD5_CAST128_CBC";
            //case CKM_PBE_SHA1_CAST5_CBC: return "PBE_SHA1_CAST5_CBC";
            case CKM_PBE_SHA1_CAST128_CBC: return "PBE_SHA1_CAST128_CBC";
            ...
            case CKM_WTLS_PRE_MASTER_KEY_GEN: return "WTLS_PRE_MASTER_KEY_GEN";
            case CKM_WTLS_MASTER_KEY_DERIVE: return "WTLS_MASTER_KEY_DERIVE";
            case CKM_WTLS_MASTER_KEY_DERIVE_DH_ECC: return "WTLS_MASTER_KEY_DERIVE_DH_ECC";
            case CKM_WTLS_PRF: return "WTLS_PRF";
            case CKM_WTLS_SERVER_KEY_AND_MAC_DERIVE: return "WTLS_SERVER_KEY_AND_MAC_DERIVE";
            case CKM_WTLS_CLIENT_KEY_AND_MAC_DERIVE: return "WTLS_CLIENT_KEY_AND_MAC_DERIVE";
            case CKM_TLS10_MAC_SERVER: return "TLS10_MAC_SERVER";
            case CKM_TLS10_MAC_CLIENT: return "TLS10_MAC_CLIENT";
            case CKM_TLS12_MAC: return "TLS12_MAC";
            case CKM_TLS12_KDF: return "TLS12_KDF";
            case CKM_TLS12_MASTER_KEY_DERIVE: return "TLS12_MASTER_KEY_DERIVE";
            case CKM_TLS12_KEY_AND_MAC_DERIVE: return "TLS12_KEY_AND_MAC_DERIVE";
            case CKM_TLS12_MASTER_KEY_DERIVE_DH: return "TLS12_MASTER_KEY_DERIVE_DH";
            case CKM_TLS12_KEY_SAFE_DERIVE: return "TLS12_KEY_SAFE_DERIVE";
            case CKM_TLS_MAC: return "TLS_MAC";
            case CKM_TLS_KDF: return "TLS_KDF";
            case CKM_KEY_WRAP_LYNKS: return "KEY_WRAP_LYNKS";
            case CKM_KEY_WRAP_SET_OAEP: return "KEY_WRAP_SET_OAEP";
            case CKM_CMS_SIG: return "CMS_SIG";
            case CKM_KIP_DERIVE: return "KIP_DERIVE";
            case CKM_KIP_WRAP: return "KIP_WRAP";
            case CKM_KIP_MAC: return "KIP_MAC";
            case CKM_ARIA_KEY_GEN: return "ARIA_KEY_GEN";
            case CKM_ARIA_ECB: return "ARIA_ECB";
            case CKM_ARIA_CBC: return "ARIA_CBC";
            case CKM_ARIA_MAC: return "ARIA_MAC";
            case CKM_ARIA_MAC_GENERAL: return "ARIA_MAC_GENERAL";
            case CKM_ARIA_CBC_PAD: return "ARIA_CBC_PAD";
            case CKM_ARIA_ECB_ENCRYPT_DATA: return "ARIA_ECB_ENCRYPT_DATA";
            case CKM_ARIA_CBC_ENCRYPT_DATA: return "ARIA_CBC_ENCRYPT_DATA";
            case CKM_SEED_KEY_GEN: return "SEED_KEY_GEN";
            case CKM_SEED_ECB: return "SEED_ECB";
            case CKM_SEED_CBC: return "SEED_CBC";
            case CKM_SEED_MAC: return "SEED_MAC";
            case CKM_SEED_MAC_GENERAL: return "SEED_MAC_GENERAL";
            case CKM_SEED_CBC_PAD: return "SEED_CBC_PAD";
            case CKM_SEED_ECB_ENCRYPT_DATA: return "SEED_ECB_ENCRYPT_DATA";
            case CKM_SEED_CBC_ENCRYPT_DATA: return "SEED_CBC_ENCRYPT_DATA";
            ...
            case CKM_ECDSA_SHA224: return "ECDSA_SHA224";
            case CKM_ECDSA_SHA256: return "ECDSA_SHA256";
            case CKM_ECDSA_SHA384: return "ECDSA_SHA384";
            case CKM_ECDSA_SHA512: return "ECDSA_SHA512";
            ...
            case CKM_ECDH_AES_KEY_WRAP: return "ECDH_AES_KEY_WRAP";
            case CKM_RSA_AES_KEY_WRAP: return "RSA_AES_KEY_WRAP";
            ...
            case CKM_AES_CTR: return "AES_CTR";
            case CKM_AES_GCM: return "AES_GCM";
            case CKM_AES_CCM: return "AES_CCM";
            case CKM_AES_CTS: return "AES_CTS";
            case CKM_AES_CMAC: return "AES_CMAC";
            case CKM_AES_CMAC_GENERAL: return "AES_CMAC_GENERAL";
            case CKM_AES_XCBC_MAC: return "AES_XCBC_MAC";
            case CKM_AES_XCBC_MAC_96: return "AES_XCBC_MAC_96";
            case CKM_AES_GMAC: return "AES_GMAC";
            case CKM_BLOWFISH_KEY_GEN: return "BLOWFISH_KEY_GEN";
            case CKM_BLOWFISH_CBC: return "BLOWFISH_CBC";
            case CKM_TWOFISH_KEY_GEN: return "TWOFISH_KEY_GEN";
            case CKM_TWOFISH_CBC: return "TWOFISH_CBC";
            case CKM_BLOWFISH_CBC_PAD: return "BLOWFISH_CBC_PAD";
            case CKM_TWOFISH_CBC_PAD: return "TWOFISH_CBC_PAD";
            case CKM_DES_ECB_ENCRYPT_DATA: return "DES_ECB_ENCRYPT_DATA";
            case CKM_DES_CBC_ENCRYPT_DATA: return "DES_CBC_ENCRYPT_DATA";
            case CKM_DES3_ECB_ENCRYPT_DATA: return "DES3_ECB_ENCRYPT_DATA";
            case CKM_DES3_CBC_ENCRYPT_DATA: return "DES3_CBC_ENCRYPT_DATA";
            case CKM_AES_ECB_ENCRYPT_DATA: return "AES_ECB_ENCRYPT_DATA";
            case CKM_AES_CBC_ENCRYPT_DATA: return "AES_CBC_ENCRYPT_DATA";
            case CKM_GOSTR3410_KEY_PAIR_GEN: return "GOSTR3410_KEY_PAIR_GEN";
            case CKM_GOSTR3410: return "GOSTR3410";
            case CKM_GOSTR3410_WITH_GOSTR3411: return "GOSTR3410_WITH_GOSTR3411";
            case CKM_GOSTR3410_KEY_WRAP: return "GOSTR3410_KEY_WRAP";
            case CKM_GOSTR3410_DERIVE: return "GOSTR3410_DERIVE";
            case CKM_GOSTR3411: return "GOSTR3411";
            case CKM_GOSTR3411_HMAC: return "GOSTR3411_HMAC";
            case CKM_GOST28147_KEY_GEN: return "GOST28147_KEY_GEN";
            case CKM_GOST28147_ECB: return "GOST28147_ECB";
            ...
            case CKM_DSA_PROBABLISTIC_PARAMETER_GEN: return "DSA_PROBABLISTIC_PARAMETER_GEN";
            case CKM_DSA_SHAWE_TAYLOR_PARAMETER_GEN: return "DSA_SHAWE_TAYLOR_PARAMETER_GEN";
            case CKM_AES_OFB: return "AES_OFB";
            case CKM_AES_CFB64: return "AES_CFB64";
            case CKM_AES_CFB8: return "AES_CFB8";
            case CKM_AES_CFB128: return "AES_CFB128";
            case CKM_AES_CFB1: return "AES_CFB1";
            case CKM_VENDOR_DEFINED: return "VENDOR_DEFINED";
            case CKM_SHA224: return "SHA224";
            case CKM_SHA224_HMAC: return "SHA224_HMAC";
            case CKM_SHA224_HMAC_GENERAL: return "SHA224_HMAC_GENERAL";
            case CKM_SHA224_RSA_PKCS: return "SHA224_RSA_PKCS";
            case CKM_SHA224_RSA_PKCS_PSS: return "SHA224_RSA_PKCS_PSS";
            case CKM_SHA224_KEY_DERIVATION: return "SHA224_KEY_DERIVATION";
            case CKM_CAMELLIA_KEY_GEN: return "CAMELLIA_KEY_GEN";
            case CKM_CAMELLIA_ECB: return "CAMELLIA_ECB";
            case CKM_CAMELLIA_CBC: return "CAMELLIA_CBC";
            case CKM_CAMELLIA_MAC: return "CAMELLIA_MAC";
            case CKM_CAMELLIA_MAC_GENERAL: return "CAMELLIA_MAC_GENERAL";
            case CKM_CAMELLIA_CBC_PAD: return "CAMELLIA_CBC_PAD";
            case CKM_CAMELLIA_ECB_ENCRYPT_DATA: return "CAMELLIA_ECB_ENCRYPT_DATA";
            case CKM_CAMELLIA_CBC_ENCRYPT_DATA: return "CAMELLIA_CBC_ENCRYPT_DATA";
            case CKM_CAMELLIA_CTR: return "CAMELLIA_CTR";
            case CKM_AES_KEY_WRAP: return "AES_KEY_WRAP";
            case CKM_AES_KEY_WRAP_PAD: return "AES_KEY_WRAP_PAD";
    ...
    const char* PKCS11::rvString(const CK_RV & rv)
    {
        switch(rv)
        {
            ...
            case CKR_ACTION_PROHIBITED: return "ACTION_PROHIBITED";
            ...
            case CKR_CURVE_NOT_SUPPORTED: return "CURVE_NOT_SUPPORTED";
            ...
            case CKR_NEW_PIN_MODE: return "NEW_PIN_MODE";
            case CKR_NEXT_OTP: return "NEXT_OTP";
            case CKR_EXCEEDED_MAX_ITERATIONS: return "EXCEEDED_MAX_ITERATIONS";
            case CKR_FIPS_SELF_TEST_FAILED: return "FIPS_SELF_TEST_FAILED";
            case CKR_LIBRARY_LOAD_FAILED: return "LIBRARY_LOAD_FAILED";
