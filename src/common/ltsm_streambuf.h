...
namespace LTSM {
    ...
    class MemoryStream : protected ByteOrderInterface {
      public:
        ...
        inline uint8_t readInt8(void) const {
            return getInt8();
        }
        ...
        inline uint16_t readIntLE16(void) const {
            return getIntLE16();
        }

        inline uint32_t readIntLE32(void) const {
            return getIntLE32();
        }

        inline uint64_t readIntLE64(void) const {
            return getIntLE64();
        }

        inline uint16_t readIntBE16(void) const {
            return getIntBE16();
        }

        inline uint32_t readIntBE32(void) const {
            return getIntBE32();
        }

        inline uint64_t readIntBE64(void) const {
            return getIntBE64();
        };
        ...
        inline MemoryStream & writeIntLE16(uint16_t v) {
            putIntLE16(v);
            return *this;
        }

        inline MemoryStream & writeIntLE32(uint32_t v) {
            putIntLE32(v);
            return *this;
        }

        inline MemoryStream & writeIntLE64(uint64_t v) {
            putIntLE64(v);
            return *this;
        }

        inline MemoryStream & writeIntBE16(uint16_t v) {
            putIntBE16(v);
            return *this;
        }

        inline MemoryStream & writeIntBE32(uint32_t v) {
            putIntBE32(v);
            return *this;
        }
