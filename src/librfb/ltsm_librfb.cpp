...
namespace LTSM {
    ...
    bool RFB::isVideoEncoding(int type) {
        auto types = {
            ...
            ENCODING_LTSM_H264, ENCODING_LTSM_AV1, ENCODING_LTSM_VP8, ENCODING_LTSM_LZ4, ENCODING_LTSM_TJPG, ENCODING_LTSM_QOI
        };
    ...
    int RFB::encodingType(std::string_view name) {
        auto types = {
            ...
            ENCODING_LTSM, ENCODING_LTSM_H264, ENCODING_LTSM_AV1, ENCODING_LTSM_VP8, ENCODING_LTSM_LZ4, ENCODING_LTSM_TJPG, ENCODING_LTSM_QOI,
