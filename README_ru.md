...
* Реализован редирект звука через pulseaudio (в обоих направлениях)
...
Ведутся работы по добавлению folder redirection (через FUSE), также ведутся работы по видео фиксации всех рабочих сессий, также есть рабочие наработки по добавлению pkcs11 в инфраструктуру.  
