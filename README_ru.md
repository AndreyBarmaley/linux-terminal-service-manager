...
Ведутся работы по добавлению редиректа сканеров (через SANE backend) folder redirection (через FUSE), также ведутся работы по видео фиксации всех рабочих сессий.  
