...
# LTSM_vnc2sdl
экпериментальный графический клиент, в котором реализован механизм множественных каналов данных, максимально до 253.  
...
так же есть рабочие схемы аутенфикации по rutoken и трасферингу файлов через drag&drop.
